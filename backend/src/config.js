...
<<<<<<< HEAD
const CONTRACT_NAME = 'MannyNFT';
const CONTRACT_SYMBOL = 'MANNY';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = '0xFC0aaecD16035130a45400AB97805B189A5F4e43';
const TREASURY_ADDRESS = '0xFC0aaecD16035130a45400AB97805B189A5F4e43';
...
const ROYALTY_ADDRESS = "0xFC0aaecD16035130a45400AB97805B189A5F4e43"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0xFC0aaecD16035130a45400AB97805B189A5F4e43"]; // only update if you want to manually set the whitelisted addresses
=======
...
"0x931f9F7F8C358443c31a378AE1376d57C52e52f2","0x462d3fABBaa3a31BdDa06505e1C06b67dd506826","0x716525e329a6Ecf08741b6D06925BcE94A0D8804","0x567212Fb1ecAD93322F6923C122970a0842Aa460","0x7E055C1d6B5740AdB881904CB4FE9e6F12f2cf15",
"0x06DA7F747A29D40226AEE48A4Bf2c914682E3DBC","0xb503a8cE39B1874aB71cfCC1171a164b390a43e3"]; // only update if you want to manually set the whitelisted addresses
>>>>>>> 315cc3e0ffa0bb85264827552d9d49c7f7bdc100
...
const GENERIC_TITLE = "MannyNFT"; // Replace with what you want the generic titles to say if you want it to be different from the contract name.
const GENERIC_DESCRIPTION = "Which MANNY will you be paired with?"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafkreicdqwqa6bqhe77g32tmhri5lkyggk3vl7f74a5zwa3ixdc5k5ixvm"; // Replace with your generic image that will display for all NFTs pre-reveal.
=======
